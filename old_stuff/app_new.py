...
def printer_pause_resume():
    print("Current printing state:", print_handler.is_printing())
    print("Current paused state:", print_handler.is_paused())
...
def start_print(data, wobble):
    ...
    while printing:
        ...
        x_position = x_position + random.randint(-5, 5)
        y_position = y_position + random.randint(-5, 5)
...
if __name__ == '__main__':
    #socketio.run(app, debug=True) #for development
    FlaskUI(
        app=app,
        socketio=socketio,

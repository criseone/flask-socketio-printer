...
const vm = new Vue({ // Again, vm is our Vue instance's name for consistency.
    ...
    mounted() {
        ...
        // Listen for printing state updates from the backend
        socket.on('update_printing_state', (data) => {
            this.isPrinting = data.isPrinting;
            if (!this.isPrinting) {
                this.pauseLable = "Resume";  // Update button label
            } else {
                this.pauseLable = "Pause";  // Update button label
            }
        });
    }
})